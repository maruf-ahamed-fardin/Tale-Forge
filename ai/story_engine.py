    ...
    def _compose_story(self, prompt: str, is_bengali: bool, reference_snippets: list[str]) -> str:
        ...
        generators = {
            "romance": {
                ...
                "climaxes": [
                    f"\"{prompt}\"—এই আবেগঘন মুহূর্তটি যেন শুধু কোনো ক্ষণস্থায়ী কল্পনা নয়, দুজনের এত বছরের চাপা কান্নার অবসান। {hero} মৃদু হেসে বলল, \"জীবন আমাদের যেখানেই নিয়ে যাক না কেন, আমাদের ভালোবাসার ঠিকানা কখনো বদলায়নি।\" {heroine}-র চোখের কোণে চিকচিক করে উঠল এক ফোঁটা আনন্দাশ্রু।",
            ...
            "rain": {
                ...
                "climaxes": [
                    f"\"{prompt}\"—বৃষ্টির এই উন্মুক্ত ধারায় দাঁড়িয়ে ভাবনাটি যেন নতুন রূপ ধারণ করল। বৃষ্টির শীতল জলে সমস্ত পুরনো কষ্ট, দ্বিধা আর না-পাওয়ার গ্লানি ধুয়ে মুছে একাকার হয়ে গেল। মনের ক্যানভাসে জন্ম নিল এক নতুন সূচনার সাহস।",
                ],
                "endings": [
            ...
            "horror": {
                ...
                "climaxes": [
                    f"\"{prompt}\"—এই চিন্তাটি মাথায় আসতেই চারপাশের অন্ধকার যেন আরও ঘন হয়ে চেপে বসল। অন্ধকারের বুক চিরে ভেসে উঠল এক জোড়া রক্তাভ জ্বলজ্বলে অপলক চোখ! কোনো মানবীয় স্বর নয়, এক অতিপ্রাকৃতিক তীব্র অনুভূতি চারপাশকে গ্রাস করে নিল।",
                ],
                "endings": [
            ...
            "mystery": {
                ...
                "climaxes": [
                    f"\"{prompt}\"—অবশেষে মিলল সেই বহুদিনের কাঙ্ক্ষিত উত্তর। প্রতিটি খাপছাড়া সূত্র এক নিমেষে জুড়ে গিয়ে এক বিস্ময়কর সত্য চোখের সামনে উন্মোচিত করে দিল।",
                ],
                "endings": [
            ...
            "general": {
                ...
                "climaxes": [
                    f"\"{prompt}\"—এই চিন্তাটি যেন অন্তরের অন্তস্তলে এক নতুন আশার মশাল জ্বেলে দিল। জীবনের প্রকৃত গৌরব তো কখনো পড়ে না যাওয়ায় নয়, বরং প্রতিবার পড়ে যাওয়ার পর আরও দৃঢ়ভাবে উঠে দাঁড়ানোর মাঝেই নিহিত।",
                ],
                "endings": [
